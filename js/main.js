...
if(sessionStorage.getItem("ring") && sessionStorage.getItem("main-diamond") && sessionStorage.getItem("price1")){
    var prod1 =("<div class='row'><div class='col-md-4 text-white text-center' id='product-cart'></div><div class='col-md-4 text-white text-center'><img id='cart-img' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cart-price'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct1()'></i> </div></div></div>");
...
if(sessionStorage.getItem("productname1") && sessionStorage.getItem("productpic1") && sessionStorage.getItem("productprice1")){
    var prod3 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart1'></div><div class='col-md-4 text-white text-center'> <img id='cartimg1' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice1'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct3()'></i> </div></div></div>");
...
if(sessionStorage.getItem("productname2") && sessionStorage.getItem("productpic2") && sessionStorage.getItem("productprice2")){
    var prod4 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart2'></div><div class='col-md-4 text-white text-center'> <img id='cartimg2' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice2'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct4()'><i> </div></div></div>");
...
if(sessionStorage.getItem("productname3") && sessionStorage.getItem("productpic3") && sessionStorage.getItem("productprice3")){
    var prod5 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart3'></div><div class='col-md-4 text-white text-center'> <img id='cartimg3' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice3'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct5()'><i> </div></div></div>");
...
if(sessionStorage.getItem("productname4") && sessionStorage.getItem("productpic4") && sessionStorage.getItem("productprice4")){
    var prod6 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart4'></div><div class='col-md-4 text-white text-center'> <img id='cartimg4' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice4'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct6()'><i> </div></div></div>");
...
if(sessionStorage.getItem("productname5") && sessionStorage.getItem("productpic5") && sessionStorage.getItem("productprice5")){
    var prod7 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart5'></div><div class='col-md-4 text-white text-center'> <img id='cartimg5' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice5'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct7()'><i> </div></div></div>");
...
if(sessionStorage.getItem("productname6") && sessionStorage.getItem("productpic6") && sessionStorage.getItem("productprice6")){
    var prod8 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart6'></div><div class='col-md-4 text-white text-center'> <img id='cartimg6' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice6'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct8()'><i> </div></div></div>");
...
if(sessionStorage.getItem("productname7") && sessionStorage.getItem("productpic7") && sessionStorage.getItem("productprice7")){
    var prod9 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart7'></div><div class='col-md-4 text-white text-center'> <img id='cartimg7' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice7'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct9()'><i> </div></div></div>");
...
if(sessionStorage.getItem("productname9") && sessionStorage.getItem("productpic9") && sessionStorage.getItem("productprice9")){
    var prod11 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart9'></div><div class='col-md-4 text-white text-center'> <img id='cartimg9' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice9'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct11()'><i> </div></div></div>");
...
function tekken7(){
    ...
    var productpic10 = document.getElementById("productpic10").getAttribute("src");
...
if(sessionStorage.getItem("productname10") && sessionStorage.getItem("productpic10") && sessionStorage.getItem("productprice10")){var prod12 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='productcart10'></div><div class='col-md-4 text-white text-center'> <img id='cartimg10' class='img-fluid rounded-circle' width='14%'></div><div class='col-md-4 text-white text-center' id='cartprice10'><div class='icon-cross'><i class='bx bx-x text-white' onclick='removeproduct12()'><i> </div></div></div>");
...
if(sessionStorage.getItem("artificalname") && sessionStorage.getItem("artifical1") && sessionStorage.getItem("artificalprice")){var prod13 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='atiname'></div><div class='col-md-4 text-white text-center'> <img id='atiimage' class='img-fluid rounded-circle' width='18%'></div><div class='col-md-4 text-white text-center' id='atiprice'><div class='icon-cross'><i class='bx bx-x text-white' onclick='remover1()'><i> </div></div></div>");
...
if(sessionStorage.getItem("artificalname1") && sessionStorage.getItem("artifical2") && sessionStorage.getItem("artificalprice1")){var prod14 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='atiname1'></div><div class='col-md-4 text-white text-center'> <img id='atiimage1' class='img-fluid rounded-circle' width='18%'></div><div class='col-md-4 text-white text-center' id='atiprice1'><div class='icon-cross'><i class='bx bx-x text-white' onclick='remover2()'><i> </div></div></div>");
...
if(sessionStorage.getItem("artificalname2") && sessionStorage.getItem("artifical3") && sessionStorage.getItem("artificalprice2")){var prod15 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='atiname2'></div><div class='col-md-4 text-white text-center'> <img id='atiimage2' class='img-fluid rounded-circle' width='18%'></div><div class='col-md-4 text-white text-center' id='atiprice2'><div class='icon-cross'><i class='bx bx-x text-white' onclick='remover3()'><i> </div></div></div>");
...
if(sessionStorage.getItem("artificalname3") && sessionStorage.getItem("artifical4") && sessionStorage.getItem("artificalprice3")){var prod16 =("<br><div class='row'><div class='col-md-4 text-white text-center' id='atiname3'></div><div class='col-md-4 text-white text-center'> <img id='atiimage3' class='img-fluid rounded-circle' width='18%'></div><div class='col-md-4 text-white text-center' id='atiprice3'><div class='icon-cross'><i class='bx bx-x text-white' onclick='remover4()'><i> </div></div></div>");
